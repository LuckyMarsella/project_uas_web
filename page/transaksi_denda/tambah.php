<?php
	$pinjam = date("d-m-Y");
	$tiga_hari = strtotime(0,0,0,date("n"),date("j")+3,date("Y"));
...
if (isset($_POST['simpan'])) 
{
	...
	$siswa			= $pecah_siswa[1];
		...
		while ($hasil=$query->fetch_assoc()) {
			...
			elseif(!$num1)
			{
				$qt = $koneksi->query("INSERT INTO tb_transaksi VALUES (null, '$id_buku', '$judul', '$id_siswa', '$siswa', '$tgl_pinjam', '$tgl_kembali', 'Pinjam', null)") or die ("Gagal Masuk".mysqli_error());
