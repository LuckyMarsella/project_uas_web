                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a  href="?page=denda"></i> Data Denda</a></li>
                        </ul>
                     </li>
                    <li>
                        <a  href="#"><i class="fa fa-edit fa-2x"></i></i> Data Transaksi <span class="fa arrow"></span</a>
                        <ul class="nav nav-second-level">
                            <li><a href="?page=transaksi_denda"></i> Transaksi Denda </a></li>
                            <li><a href="?page=transaksi"></i> Transaksi Hari </a></li>
                        </ul>
                    </li>
